      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using College Football 27 Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and College Football 27 Wiki.
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by College Football 27 Wiki and are protected by international
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, COLLEGE FOOTBALL 27 WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and College Football 27 Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
